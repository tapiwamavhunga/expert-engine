...
class OrderController extends Controller {
    ...
    public function store(Request $request, ) {
		...
		//$order->visa_number_expiration = $request->visa_number_expiration;
            ...
            return redirect()->route('admin.orders.create', [])->withInput($request->input())->withErrors(['error' => $e->getMessage()]);
        }
    }
    ...
    public function update(Request $request, Order $order,) {
		...
		$order->tsa_precheck_number = $request->tsa_precheck_number;
            ...
            return redirect()->route('admin.orders.index', [])->with('success', __('Order edited successfully.'));
        } catch (\Throwable $e) {
            return redirect()->route('admin.orders.edit', compact('order'))->withInput($request->input())->withErrors(['error' => $e->getMessage()]);
        }
    }
    ...
    public function destroy(Order $order,) {
        ...
        try {
            ...
            return redirect()->route('admin.orders.index', [])->with('error', 'Cannot delete Order: ' . $e->getMessage());
        }
    }
