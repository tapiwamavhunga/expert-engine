...
@section('userPreference.content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('users.user_preferences.store', compact('user')) }}" method="POST" class="m-0 p-0">
                    <div class="card-body">
                        @csrf
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            <a href="{{ route('users.user_preferences.index', compact('user')) }}" class="btn btn-light">@lang('Cancel')</a>
                            <button type="submit" class="btn btn-primary">@lang('Create new User Preference')</button>
                        </div>
                    </div>
                </form>
            </div>
