...
@section('userTravelRecquest.content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('users.user_travel_recquests.store', compact('user')) }}" method="POST" class="m-0 p-0">
                    <div class="card-body">
                        @csrf
                        <div class="mb-3">
		...
		@endif
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            <a href="{{ route('users.user_travel_recquests.index', compact('user')) }}" class="btn btn-light">@lang('Cancel')</a>
                            <button type="submit" class="btn btn-primary">@lang('Create new User Travel Recquest')</button>
                        </div>
                    </div>
                </form>
            </div>
