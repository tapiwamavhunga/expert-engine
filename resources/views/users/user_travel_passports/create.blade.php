...
@section('userTravelPassports.content')
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('users.user_travel_passports.store', compact('user')) }}" method="POST" class="m-0 p-0">
                    <div class="card-body">
                        @csrf
                        <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="date" name="passport_date_issued" id="passport_date_issued" class="form-control" value="{{@old('passport_date_issued')}}" />
    ...
    <div class="mb-3">
        ...
        <input type="date" name="passport_date_expiry" id="passport_date_expiry" class="form-control" value="{{@old('passport_date_expiry')}}" />
		...
		@endif
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            <a href="{{ route('users.user_travel_passports.index', compact('user')) }}" class="btn btn-light">@lang('Cancel')</a>
                            <button type="submit" class="btn btn-primary">@lang('Create new User Travel Passport')</button>
                        </div>
                    </div>
                </form>
            </div>
