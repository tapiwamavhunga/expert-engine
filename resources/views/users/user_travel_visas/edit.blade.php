...
@section('userTravelVisas.content')
        ...
        <div class="card">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item">@lang('Edit User Travel Visa') #{{$userTravelVisa->id}}</li>
                </ol>
            </div>
            <div class="card-body">
                <form action="{{ route('users.user_travel_visas.update', compact('user', 'userTravelVisa')) }}" method="POST" class="m-0 p-0">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
        <label for="visa_nationality" class="form-label">Visa Nationality:</label>
        <input type="text" name="visa_nationality" id="visa_nationality" class="form-control" value="{{@old('visa_nationality', $userTravelVisa->visa_nationality)}}" />
    ...
    <div class="mb-3">
        ...
        <input type="text" name="visa_type" id="visa_type" class="form-control" value="{{@old('visa_type', $userTravelVisa->visa_type)}}" />
    ...
    <div class="mb-3">
        ...
        <input type="text" name="visa_number" id="visa_number" class="form-control" value="{{@old('visa_number', $userTravelVisa->visa_number)}}" />
    ...
    <div class="mb-3">
        ...
        <input type="date" name="visa_number_expiration" id="visa_number_expiration" class="form-control" value="{{@old('visa_number_expiration', $userTravelVisa->visa_number_expiration)}}" />
		...
		@endif
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            <a href="{{ route('users.user_travel_visas.index', compact('user')) }}" class="btn btn-light">Cancel</a>
                            <button type="submit" class="btn btn-primary">@lang('Update User Travel Visa')</button>
                        </div>
                    </div>
                </form>
            </div>
