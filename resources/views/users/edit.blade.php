...
{{-- CONTAINER --}}
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.users.update', compact('user')) }}" method="POST" class="m-0 p-0">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
    ...
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="is_activated" id="is_activated_yes" value="1" {{ @old('is_activated', $user->is_activated) == '1' ? 'checked' : '' }} required>
        <label class="form-check-label" for="inlineRadio1">Yes</label>
    </div>
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="is_activated" id="is_activated_no" value="0" {{ @old('is_activated', $user->is_activated) == '0' ? 'checked' : '' }} required>
